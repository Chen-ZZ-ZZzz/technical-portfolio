...
from alerce_qa.client import _api_call, fetch_candidates, fetch_object_data
...
class TestApiCall:
    ...
    def test_api_error_exhausts_retries(self):
        ...
        with patch("alerce_qa.client.time.sleep"):
            result, err = _api_call(fn)
        assert result is None
    ...
    def test_api_error_retries_before_failing(self):
        ...
        with patch("alerce_qa.client.time.sleep") as mock_sleep:
            _api_call(fn)
...
class TestFetchCandidates:
    ...
    def test_returns_deduplicated_oids(self):
        ...
        with patch("alerce_qa.client._client") as mock_client:
